  ...
  return <section id="about" className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">પુરુષાર્થ ક્લાસ 9મા અને 10મા ધોરણના વિદ્યાર્થીઓ માટે ગુજરાતી માધ્યમમાં શ્રેષ્ઠ શિક્ષણ પ્રદાન કરે છે। With years of experience, we have helped thousands of students achieve their academic goals.</p>
        </div>

        {/* Values Grid */}
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          {values.map((item, index) => <div key={index} className="group p-6 md:p-8 bg-card rounded-2xl shadow-card hover:shadow-hover transition-all duration-300 border border-border">
