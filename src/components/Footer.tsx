        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map(link => <li key={link.name}>
                  <button onClick={() => scrollToSection(link.href)} className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    {link.name}
                  </button>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+918200912189" className="flex items-center gap-3 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  <Phone className="h-5 w-5 text-accent" />
                  <span className="text-sm">+91 82009 12189</span>
                </a>
              </li>
              <li>
                <a href="mailto:purusharthclasses@gmail.com" className="flex items-center gap-3 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
