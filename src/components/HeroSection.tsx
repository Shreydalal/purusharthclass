...
const HeroSection = () => {
  const highlights = [
    { icon: GraduationCap, text: "Experienced Faculty" },
    { icon: Award, text: "Strong Results" },
    { icon: Users, text: "Personal Attention" },
    { icon: BookOpen, text: "Conceptual Learning" },
  ];
    ...
    <section id="home" className="relative min-h-screen flex items-center pt-24 md:pt-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-xl md:text-2xl lg:text-3xl font-medium text-primary-foreground/90 mb-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            9th & 10th Gujarati Medium
          </h2>

          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 animate-fade-in" style={{ animationDelay: "0.5s" }}>
            {highlights.map((item, index) => (
              <div 
                key={index}
                className="flex flex-col items-center gap-3 p-4 md:p-6 bg-primary-foreground/5 backdrop-blur-sm border border-primary-foreground/10 rounded-xl hover:bg-primary-foreground/10 transition-all duration-300"
              >
